  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('/api/register', {
        ...
        role:       userType === 'adviser' ? 'advisor' : 'student',
        ...
        staff_id:   userType === 'adviser' ? staffId   : undefined,
        department: userType === 'adviser' ? department: undefined,
      });
                ...
                <div className="field-group">
                  ...
                  <div className="select-wrap">
                    ...
                    >
                      ...
                      <option value="adviser">Club Adviser</option>
                    </select>
