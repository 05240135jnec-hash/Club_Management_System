...
import '../../styles/secretary/enrollmentkey.css';

export default function SecretaryEnrollmentKey() {
  ...
  const handleGenerate = async () => {
    ...
    const result = await Swal.fire({
      ...
      text: 'A random key will replace the current one.',
      icon: 'question',
  ...
  return (
    <SecretaryLayout title="Enrollment Key" subtitle="Manage club enrollment keys">
            ...
            <div style={{ padding:'24px 24px 28px', display:'flex', flexDirection:'column', gap:16 }}>
              <div style={{ display:'flex', flexDirection:'column', gap:5 }}>
                ...
                <input
                  ...
                  onFocus={e => { e.target.style.borderColor='#5fbfad'; e.target.style.background='#fff'; }}
              ...
              <div style={{ display:'flex', gap:10, marginTop:4 }}>
                ...
                <button onClick={handleEditSave} disabled={editSaving} style={{ flex:2, display:'flex', alignItems:'center', justifyContent:'center', gap:7, padding:'10px 16px', fontSize:13, fontWeight:700, fontFamily:'inherit', background:'#172D3D', color:'#5fbfad', border:'none', borderRadius:9, cursor:'pointer', opacity:editSaving?0.7:1 }}>
