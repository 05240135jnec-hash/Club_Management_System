...
export default function SecretarySettings() {
  ...
  return (
    <SecretaryLayout title="Settings" subtitle="Application settings">
      <div>
        ...
        <div
          ...
          onMouseEnter={e => { e.currentTarget.style.boxShadow='0 4px 16px rgba(95,191,173,0.15)'; e.currentTarget.style.borderColor='#b2f0e8'; }}
          onMouseLeave={e => { e.currentTarget.style.boxShadow='0 1px 4px rgba(0,0,0,0.07)'; e.currentTarget.style.borderColor='transparent'; }}
        >
          <div style={{ width:48, height:48, borderRadius:12, background:'#f0fdf8', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
            <svg viewBox="0 0 24 24" fill="none" stroke="#5fbfad" strokeWidth="2" width="22" height="22" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="sl-modal-backdrop" onClick={() => setPwdOpen(false)}>
          <div className="sl-profile-modal" onClick={e => e.stopPropagation()} style={{maxWidth:420}}>
            <div className="sl-pm-header">
              ...
              <button className="sl-pm-close" onClick={() => setPwdOpen(false)}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="18" height="18"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
              </button>
            </div>
            <div className="sl-pm-body">
              <div style={{width:64,height:64,borderRadius:'50%',background:'#f0fdf8',display:'flex',alignItems:'center',justifyContent:'center',marginBottom:8}}>
                <svg viewBox="0 0 24 24" fill="none" stroke="#5fbfad" strokeWidth="2" width="28" height="28"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
              </div>
