    ...
    <div className="yoe-cal" ref={ref}>
      <button className={`yoe-cal-btn${open ? ' open' : ''}`} onClick={() => setOpen(v => !v)} type="button">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
          strokeLinecap="round" strokeLinejoin="round" className="yoe-cal-icon">
      ...
      {open && (
        <div className="yoe-cal-pop">
          <div className="yoe-cal-head">
            <button className="yoe-cal-nav" onClick={prev}>
            ...
            <button className="yoe-cal-nav" onClick={nxt}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"
                strokeLinecap="round" strokeLinejoin="round" width="13" height="13">
          ...
          <div className="yoe-cal-foot">
            ...
            <button className="yoe-cal-foot-btn blue" onClick={() => {
              const t = new Date(); setVY(t.getFullYear()); setVM(t.getMonth()); pick(t.getDate());
            }}>Today</button>
          </div>
        </div>
      )}
...
export default function AdvisorAnnouncements() {
  ...
  /* hamburger — same pattern as StudentPublicAnnouncements */
  ...
  async function fetchAll() {
    ...
    try {
      ...
      const [a, c, cl] = await Promise.allSettled([
        axios.get('/api/advisor/announcements', { headers: H }),
  ...
  const filtered = announcements.filter(a => {
    ...
    let mD = true;
    if (filterDate) {
      const ad = new Date(a.date_sent || a.created_at), fd = new Date(filterDate);
      mD = !isNaN(ad) && !isNaN(fd) &&
        ad.getFullYear() === fd.getFullYear() &&
        ad.getMonth()    === fd.getMonth()    &&
        ad.getDate()     === fd.getDate();
    }
    return mS && mT && mD;
  });

  const hasFilter = filterType || filterDate;
    ...
    <>
      ...
      <div className="yoe-top-bar">
        <div className="yoe-top-bar-left">
          <button className="yoe-top-bar-link" onClick={() => navigate('/advisor/dashboard')}>
            Home
          </button>
          <button
      ...
      {/* ── BAR 2: Navy navbar — hamburger only, no category pills ── */}
      <nav className={`yoe-navbar${navScrolled ? ' scrolled' : ''}`}>
        ...
        <div className="yoe-navbar-right">
          {/* 2-panel hamburger — identical to StudentPublicAnnouncements */}
  ...
  if (viewAnn) {
    ...
    const recipientsLabel =
      viewAnn.recipients === 'advisors' ? 'All Advisors' :
      viewAnn.recipients === 'both'     ? 'Advisors & Students' :
      viewAnn.recipients === 'students' ? 'All Students' : '—';

    return (
      <div className="yoe-page">
        <TopBar currentView="detail" />
        <div className="yoe-body">
          <button className="yoe-back-btn"
            onClick={() => { setViewAnn(null); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
          ...
          <div className="yoe-detail-card">
            ...
            <div className="yoe-detail-meta">
              <div className="yoe-meta-item">
                ...
                <span className="yoe-meta-val">{recipientsLabel}</span>
              </div>
    ...
    <div className="yoe-page">
      ...
      <div className="yoe-body">
        <div className="yoe-page-header">
          <h1 className="yoe-page-title">Announcements</h1>
          <div className="yoe-filters">
            ...
            {hasFilter && (
              <button className="yoe-clear-btn"
